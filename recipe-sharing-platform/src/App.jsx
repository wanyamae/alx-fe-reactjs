      ...
      <section className="relative w-full h-[320px] md:h-[400px] lg:h-[480px] mb-12">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="bg-black bg-opacity-40 p-8 rounded-lg">
            <h1 className="text-white text-2xl md:text-4xl font-bold mb-2 text-center">
              Bring digital to every person,<br />home and organization<br />for a fully connected, intelligent world
            </h1>
          </div>
        </div>
      </section>
